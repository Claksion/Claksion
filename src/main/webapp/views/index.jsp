              ...
              <span class="app-brand-logo demo">
                ...
                >
                  ...
                  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2">Claksion</span>
                </a>

                <a href="<c:url value="/"/>" class="layout-menu-toggle menu-link text-large ms-auto d-block d-xl-none">
