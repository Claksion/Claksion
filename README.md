...
|                                                           Redis 투표 순위 및 투표 유저 관리<br/>Redis, SSE 실시간 투표 현황<br/>투표 생성, 참여, 실시간 결과, 최종 결과                                                            |                                                            Websocket, Stomp, Redis Pub/Sub<br/>실시간 채팅 구현<br/>   Redis 세션관리                                                         |                            소셜 로그인 및 Redis 세션 관리<br/>Redis, SSE 실시간 접속 유저 현황<br/>Redis 자리 선착순 선택 및 결과 확인                            |
